...
* File 'DecisionAnalysis/libs/x64/DecisionAnalysis.dll':
  Found no calls to: 'R_registerRoutines', 'R_useDynamicSymbols'

 \newline Users reported that this is a false positive when using devtools::check() in Rstudio.
 
* Possibly mis-spelled words in DESCRIPTION:
     MAVF (25:15, 26:73, 27:45)
     SAVF (22:62, 23:84)
     SAVFs (26:29)
     
  \newline These are acronyms and are defined in the description.
